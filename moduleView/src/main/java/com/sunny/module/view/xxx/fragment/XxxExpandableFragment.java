 ...
 */
public class XxxExpandableFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootLayout = inflater.inflate(R.layout.view_fragment_xxx_expandable, container, false);
        AppCompatTextView nameView = rootLayout.findViewById(R.id.fragment_name);
        nameView.setText("折叠布局");
        return rootLayout;
    }
}
