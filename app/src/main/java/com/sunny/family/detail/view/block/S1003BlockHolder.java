...
public class S1003BlockHolder extends DetailBlockHolder {
    ...
    private S1003BlockHolder(View root, IControllerFactory factory,
        ...
        mAdapter = ControllerAdapter.Builder.create().setCallback(callback)
                ...
                .setRecyclerViewPool(pool).setSize(4).setSpanCount(4).build();
    ...
    public static S1003BlockHolder create(@NonNull ViewGroup parent,
        ...
        params.height = ResUtils.INSTANCE.getDimensionPixelSize(R.dimen.block_s1003_height);
        recyclerView.setLayoutParams(params);

        return new S1003BlockHolder(root, factory, null);
    }
