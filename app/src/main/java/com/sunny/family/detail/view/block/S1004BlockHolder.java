...
public class S1004BlockHolder extends DetailBlockHolder {
    ...
    private S1004BlockHolder(View root, IControllerFactory factory,
        ...
        HorizontalAdapter.AdapterCallback callback = new HorizontalAdapter.AdapterCallback() {
            ...
            public void onBindController(@NonNull BasePosterController controller,
                ...
                if (controller instanceof T10000WidgetController) {
                    ...
                    controller1.reset(WidgetType.WIDGET_104, WidgetType.WIDGET_102);
        ...
        mAdapter = HorizontalAdapter.Builder.create().setCallback(callback)
                ...
                .setRecyclerViewPool(pool).setWidth(ResUtils.INSTANCE.getDimensionPixelSize(R.dimen.block_s1004_width)).build();
    ...
    public static S1004BlockHolder create(@NonNull ViewGroup parent,
        ...
        return new S1004BlockHolder(root, factory, sControllerPool);
    }
