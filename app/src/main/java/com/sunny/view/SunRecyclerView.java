...
public class SunRecyclerView extends RecyclerView {
    ...
    public SunRecyclerView(@NonNull Context context) {
        this(context, null, 0);
    }

    public SunRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SunRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
