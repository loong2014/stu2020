 ...
 */
public class JVM指令集 extends StuImpl {
    ...
    public void c_功能() {
        ...
        // 将 xxx 型常量值从【常量池】中推送至栈顶
        // xxx = 单字节(-128~127),短整型(-32768~32767), int, float或String, long或double
        /*
        ...
        // 将指定的 xxx 型【本地变量】推送至栈顶
        // xxx = int,long,float,double,引用类型
        /*
        ...
        // 将 xxx 型数组指定索引的值推送至栈顶
        // xxx = int,long,float,double,引用类型，boolean,char,short
        /*
        ...
        // 将栈顶两 xxx 型数值 相加/相减/相乘/相除/取模 并将结果压入栈顶
        ...
        // 将 xxx 型数值 左移/右(符号)移/右(无符号)移 位指定位数并将结果压入栈顶
        // xxx = int,long
        /*
        ...
        // 将栈顶两 xxx 型数值作 按位与/按位或/按位异或 并将结果压入栈顶
        // xxx = int,long
        /*
        ...
        // 将栈顶 xxx 型数值强制转换成 xxx 型数值并将结果压入栈顶
        // xxx = int,long,float,double
        /*
         ...
         */
        // 将栈顶 int 型数值强制转换成 xxx 型数值并将结果压入栈顶
        // xxx = byte,char,short
        /*
        ...
        // 比较栈顶两 xxx 型数值大小，并将结果（1，0，-1）压入栈顶
        // xxx = long,float,double
        /*
        ...
        // 从当前方法返回 xxx
        // xxx = int,long,float,double,对象引用,void
        /*
        ...
        // 锁
        /*
            0xc2	monitorenter	【获得】对象的锁，用于同步方法或同步块
            0xc3	monitorexit	    【释放】对象的锁，用于同步方法或同步块
         */
